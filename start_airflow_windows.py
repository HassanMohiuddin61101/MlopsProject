"""
Windows-compatible Airflow startup script
Patches Unix-only modules to work on Windows
"""
import sys
import os
...
# Mock fcntl module (Unix-only, needed by Gunicorn)
class MockFcntl:
